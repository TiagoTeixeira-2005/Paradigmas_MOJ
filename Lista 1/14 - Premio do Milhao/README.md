...
Seu programa deve escrever na saída uma única linha, contendo um único número inteiro, o número de dias que foram necessários para a soma dos acessos à página de Alice e Bia chegar a `1000000`.

## Restrições

- `1 ≤ N ≤ 10³`, ou seja, a lista tem no máximo `1000` números.
- `0 < A ≤ 10⁶`, ou seja, cada inteiro `A` da lista é positivo e menor do que ou igual a `1` milhão.
